...
# ==================================================
# Data Parameters
tf.flags.DEFINE_string("training_data_file", "./data/train_node_set.txt", "Data source for the training data.")
...
logger = dh.logger_fn('tflog', 'logs/test_node'+time.strftime("%m-%d-%Y-%H:%M:%S")+'.log')
...
def CNN_Test():
    ...
    with graph.as_default():
        ...
        with sess.as_default():
            ...
            # Predict by threshold
            logger.info("Predict by threshold: Recall {0:g}, accuracy {1:g}, F {2:g}"
